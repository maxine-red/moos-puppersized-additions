...
public class ModItems {
	...
	public static final RegistryObject<BlockItem> SALT_SACK = ITEMS.register("salt_sack", () -> new BlockItem(ModBlocks.SALT_SACK.get(), DEFAULT_PORPERTIES));
	...
	public static final RegistryObject<BucketItem> APPLE_JAM_BUCKET = ITEMS.register("apple_jam_bucket", () -> new BucketItem(ModFluids.APPLE_JAM, DEFAULT_BUCKET_PORPERTIES));
	...
	public static final RegistryObject<BucketItem> SEED_OIL_BUCKET = ITEMS.register("seed_oil", () -> new BurnableBucketItem(ModFluids.SEED_OIL, DEFAULT_BUCKET_PORPERTIES, 4000));
	public static final RegistryObject<BucketItem> GELATIN_BUCKET = ITEMS.register("gelatin", () -> new BucketItem(ModFluids.GELATIN, DEFAULT_BUCKET_PORPERTIES));
	...
	public static final RegistryObject<Item> APPLE_JUICE = ITEMS.register("apple_juice", () -> new JuiceItem(DEFAULT_JUICE_PORPERTIES.food(ModFoods.APPLE_JUICE).craftRemainder(GLASS_FLASK.get()), Items.APPLE, APPLE_JUICE_BUCKET.get()));
	public static final RegistryObject<Item> GOLDEN_APPLE_JUICE = ITEMS.register("golden_apple_juice", () -> new JuiceItem(DEFAULT_JUICE_PORPERTIES.food(ModFoods.GOLDEN_APPLE_JUICE).craftRemainder(GLASS_FLASK.get()).rarity(Rarity.RARE), Items.GOLDEN_APPLE, GOLDEN_APPLE_JUICE_BUCKET.get()));
	public static final RegistryObject<Item> MELON_JUICE = ITEMS.register("melon_juice", () -> new JuiceItem(DEFAULT_JUICE_PORPERTIES.food(ModFoods.MELON_JUICE).craftRemainder(GLASS_FLASK.get()), Items.MELON_SLICE, MELON_JUICE_BUCKET.get()));
	public static final RegistryObject<Item> CHORUS_JUICE = ITEMS.register("chorus_juice", () -> new JuiceItem(DEFAULT_JUICE_PORPERTIES.food(ModFoods.CHORUS_JUICE).craftRemainder(GLASS_FLASK.get()), Items.CHORUS_FRUIT, CHORUS_JUICE_BUCKET.get(), true));
	public static final RegistryObject<Item> SWEET_BERRY_JUICE = ITEMS.register("sweet_berry_juice", () -> new JuiceItem(DEFAULT_JUICE_PORPERTIES.food(ModFoods.SWEET_BERRY_JUICE).craftRemainder(GLASS_FLASK.get()), Items.SWEET_BERRIES, SWEET_BERRY_JUICE_BUCKET.get()));
	public static final RegistryObject<Item> CARROT_JUICE = ITEMS.register("carrot_juice", () -> new JuiceItem(DEFAULT_JUICE_PORPERTIES.food(ModFoods.CARROT_JUICE).craftRemainder(GLASS_FLASK.get()), Items.CARROT, CARROT_JUICE_BUCKET.get()));
	public static final RegistryObject<Item> GOLDEN_CARROT_JUICE = ITEMS.register("golden_carrot_juice", () -> new JuiceItem(DEFAULT_JUICE_PORPERTIES.food(ModFoods.GOLDEN_CARROT_JUICE).craftRemainder(GLASS_FLASK.get()).rarity(Rarity.UNCOMMON), Items.GOLDEN_CARROT, GOLDEN_CARROT_JUICE_BUCKET.get()));
