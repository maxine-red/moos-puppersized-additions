 ...
 *
 */
public class SeedOilFluid {
	public static final String ID = "seed_oil";
	...
	private static final ForgeFlowingFluid.Properties PROPERTIES = new ForgeFlowingFluid.Properties(ModFluids.SEED_OIL, ModFluids.SEED_OIL_FLOWING, ATTRIBUTES).bucket(ModItems.SEED_OIL_BUCKET);
