 ...
 *
 */
public class SweetBerryJamFluid {
	public static final String ID = "sweet_berry_jam";
	...
	private static final ForgeFlowingFluid.Properties PROPERTIES = new ForgeFlowingFluid.Properties(ModFluids.SWEET_BERRY_JAM, ModFluids.SWEET_BERRY_JAM_FLOWING, ATTRIBUTES).bucket(ModItems.SWEET_BERRY_JAM_BUCKET);
