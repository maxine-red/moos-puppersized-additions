 ...
 *
 */
public class MelonJamFluid {
	public static final String ID = "melon_jam";
	...
	private static final ForgeFlowingFluid.Properties PROPERTIES = new ForgeFlowingFluid.Properties(ModFluids.MELON_JAM, ModFluids.MELON_JAM_FLOWING, ATTRIBUTES).bucket(ModItems.MELON_JAM_BUCKET);
