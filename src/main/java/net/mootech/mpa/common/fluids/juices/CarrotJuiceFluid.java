 ...
 *
 */
public class CarrotJuiceFluid {

	public static final String ID = "carrot_juice";
	...
	private static final ForgeFlowingFluid.Properties PROPERTIES = new ForgeFlowingFluid.Properties(ModFluids.CARROT_JUICE, ModFluids.CARROT_JUICE_FLOWING, ATTRIBUTES).bucket(ModItems.CARROT_JUICE_BUCKET);
