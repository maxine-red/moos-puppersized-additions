 ...
 *
 */
public class ChorusJuiceFluid {

	public static final String ID = "chorus_juice";
	...
	private static final ForgeFlowingFluid.Properties PROPERTIES = new ForgeFlowingFluid.Properties(ModFluids.CHORUS_JUICE, ModFluids.CHORUS_JUICE_FLOWING, ATTRIBUTES).bucket(ModItems.CHORUS_JUICE_BUCKET);
