...
public class SweetBerryJuiceFluid {
	...
	public static final String ID = "sweet_berry_juice";
	...
	private static final ForgeFlowingFluid.Properties PROPERTIES = new ForgeFlowingFluid.Properties(ModFluids.SWEET_BERRY_JUICE, ModFluids.SWEET_BERRY_JUICE_FLOWING, ATTRIBUTES).bucket(ModItems.SWEET_BERRY_JUICE_BUCKET);
