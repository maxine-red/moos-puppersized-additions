 ...
 */
package net.mootech.mpa.common.fluids.juices;
 ...
 *
 */
public class GoldenCarrotJuiceFluid {

	public static final String ID = "golden_carrot_juice";
	...
	private static final ForgeFlowingFluid.Properties PROPERTIES = new ForgeFlowingFluid.Properties(ModFluids.GOLDEN_CARROT_JUICE, ModFluids.GOLDEN_CARROT_JUICE_FLOWING, ATTRIBUTES).bucket(ModItems.GOLDEN_CARROT_JUICE_BUCKET);
