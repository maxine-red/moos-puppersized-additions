 ...
 *
 */
public class ChorusJamFluid {
	public static final String ID = "chorus_jam";
	...
	private static final ForgeFlowingFluid.Properties PROPERTIES = new ForgeFlowingFluid.Properties(ModFluids.CHORUS_JAM, ModFluids.CHORUS_JAM_FLOWING, ATTRIBUTES).bucket(ModItems.CHORUS_JAM_BUCKET);
