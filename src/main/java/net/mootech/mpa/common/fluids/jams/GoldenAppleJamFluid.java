 ...
 *
 */
public class GoldenAppleJamFluid {
	public static final String ID = "golden_apple_jam";
	...
	private static final ForgeFlowingFluid.Properties PROPERTIES = new ForgeFlowingFluid.Properties(ModFluids.GOLDEN_APPLE_JAM, ModFluids.GOLDEN_APPLE_JAM_FLOWING, ATTRIBUTES).bucket(ModItems.GOLDEN_APPLE_JAM_BUCKET);
